...
var createrequestCredential = function (service) {
  return function (options, credentialRequestCompleteCallback) {
...
Oidc.registerClient = function (idp){
  Oidc[idp] = {};
  ...
  //   error.
  Oidc[idp].requestCredential = createrequestCredential(idp);
};
